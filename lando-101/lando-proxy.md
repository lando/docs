...
Using the `proxy` key in our `.lando.yml` file we can add a URL to any `service` in a Lando app! If you need to dig deeper you can find the read the [full proxy documentation](https://docs.lando.dev/core/v3/proxy.html).
